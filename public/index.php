...
$router->get('/',fn()=>$controller->page('home',['seo'=>$controller->seo('Metal Life','Caixas met&aacute;licas, quadros, gabinetes e cabines de pintura industrial sob medida. Conhe&ccedil;a as solu&ccedil;&otilde;es Metal Life.','/')]));
